...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    ...
    DATA:
      entity          TYPE STRUCTURE FOR CREATE zrap100_r_traveltp_nh1,
      travel_id_max   TYPE /dmo/travel_id,
      use_numer_range TYPE abap_bool VALUE abap_true.
    ...
    IF use_numer_range = abap_true.
      ...
      travel_id_max = num_range_key - number_range_returned_quantity.
    ELSE.
      "determine the first free travel ID without number range
      "Get max travel ID from active table
      SELECT SINGLE FROM zrap100_atrav_nh FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_dtravnh1 FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF ZRAP100_R_TravelTP_NH1 IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_NH1 IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**************************************************************************
  METHOD deductDiscount.
    DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_NH1.
...
**************************************************************************
  METHOD copyTravel.
    DATA:
       travels       TYPE TABLE FOR CREATE zrap100_r_traveltp_NH1 .
