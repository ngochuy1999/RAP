CLASS zcl_rap100_gendata_nh DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gendata_nh IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '_nh',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav_nh.
*    DELETE FROM zrap100_dtrav_nh.

    "insert travel demo data
    INSERT zrap100_atrav_nh  FROM (
        SELECT
